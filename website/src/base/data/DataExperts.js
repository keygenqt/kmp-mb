...
export const DataExperts = [
    {
        id: 1,
        name_en: 'Nikita Evdokimov',
        name_ru: 'Никита Евдокимов',
        description_en: `
Mobile Broadcast Expert for Android.
...
Nikita is the lead maintainer of Kaspresso, the author of articles about testing on Habr and Medium, and is also an active participant in the development of Kakao. Under his leadership, Kaspresso has become even more popular, and new features for the framework will appear in the near future.
        `.trim(),
        description_ru: `
Mobile Broadcast Expert по Android.
...
Никита - ведущий мейнтейнер Kaspresso, автор статей о тестировании на Habr и Medium, а также активный участник разработки Kakao. Под его руководством Kaspresso стал еще популярнее, и в ближайшее время появятся новые фитчи для фреймворка.
        ...
        quote_en: '',
        quote_ru: '',
        image: DataImages.experts.Evdokimov,
        direction: [
            'Android',
        ],
        contacts: {
        ...
        media: {
            telegram: 'https://t.me/medoviy_talks',
            github: 'https://github.com/Nikitae57',
            youtube: undefined,
            site: undefined,
        },
    },
    {
        id: 2,
        name_en: 'Alexey Gladkov',
        name_ru: 'Алексей Гладков',
        description_en: `
Mobile Broadcast Expert for Android, Aurora and Kotlin Multiplatform.
...
Co-founder of Mobile Broadcast and author of the Kotlin Multiplatform course.
        `.trim(),
        description_ru: `
Mobile Broadcast Expert по Android, Aurora и Kotlin Multiplatform.
...
Со-основатель Mobile Broadcast и автор курса по Kotlin Multiplatform.
        ...
        quote_en: '',
        quote_ru: '',
        image: DataImages.experts.Gladkov,
        direction: [
            'Android',
            'Kotlin',
            'Aurora OS',
        ...
        media: {
            ...
            github: 'https://github.com/AlexGladkov',
            youtube: 'https://www.youtube.com/@MobileDeveloper',
            site: 'https://mobiledeveloper.tech',
        },
    },
    {
        id: 3,
        name_en: 'Nikita Moshkalov',
        name_ru: 'Никита Мошкалов',
        description_en: `
...
He actively popularizes Mobile Broadcast as a community administrator in St. Petersburg, we hope that as an expert he will bring even more benefit to Mobile Broadcast!
        `.trim(),
        description_ru: `
...
Активно популяризирует Mobile Broadcast в качестве администратора сообщества в Санкт-Петербурге, надеемся, что в качестве эксперта он принесёт ещё больше пользы Mobile Broadcast!
        ...
        quote_en: '',
        quote_ru: '',
        image: DataImages.experts.Moshkalov,
        direction: [
            'Aurora OS',
        ],
        contacts: {
    ...
    {
        id: 4,
        name_en: 'Alexey Panov',
        name_ru: 'Алексей Панов',
        description_en: `
...
Нравится изучать новые технологии в мобильной разработке и делиться знаниями с сообществом. Выступал на различных конференциях и YouTube каналах, а также самостоятельно организовывал и проводил митапы в Екатеринбурге.
        ...
        quote_en: '',
        quote_ru: '',
        image: DataImages.experts.Panov,
        direction: [
            'Android',
            'Kotlin',
        ],
        ...
        media: {
            telegram: 'https://t.me/kotlin_adept',
            github: 'https://github.com/AJIEKCX',
            youtube: undefined,
            site: undefined,
        },
    },
    {
        id: 5,
        name_en: 'Kirill Popov',
        name_ru: 'Кирилл Попов',
        description_en: `
...
Сфера профессиональных интересов — повышение качества и стабильности приложений.
        ...
        quote_en: '',
        quote_ru: '',
        image: DataImages.experts.Popov,
        direction: [
            'Android'
        ],
        contacts: {
            telegram: 'https://t.me/Sk1talec',
            email: undefined,
            linkedin: undefined,
        },
        media: {
    ...
    {
        id: 6,
        name_en: 'Kirill Rozov',
        name_ru: 'Кирилл Розов',
        description_en: `
Mobile Broadcast Expert for Android.
...
Kotlin expert and Kotlin Multiplatform adherent.
...
Staff Software Engineer в Тинькофф. Занимается разработкой клиентов корпоративного мессенджера на Kotlin Multiplatform и Compose Multiplatform.
        ...
        quote_en: '',
        quote_ru: '',
        image: DataImages.experts.Rozov,
        direction: [
            'Android',
        ],
        contacts: {
            telegram: undefined,
            email: undefined,
            linkedin: 'https://www.linkedin.com/in/kirillrozov/',
        },
        media: {
            telegram: 'https://t.me/rozov_blog',
            github: undefined,
            youtube: 'https://www.youtube.com/@AndroidBroadcast',
            site: 'https://androidbroadcast.dev',
        },
    },
    {
        id: 7,
...
He is involved in the development of modern cross-platform areas in the Aurora OS, such as Flutter and Kotlin Multiplatform. Helps other mobile developers to join Aurora OS.
        `.trim(),
        description_ru: `
Mobile Broadcast Expert по Aurora, Flutter и Kotlin Multiplatform.
...
Занимается направлением развития современных кроссплатформенных направлений в ОС Аврора, таких как Flutter и Kotlin Multiplatform. Помогает другим мобильным разработчикам приобщиться к Аврора ОС.
        `.trim(),
        quote_en: 'If you study what everyone studies, write code like everyone else, relax like everyone else, you will be like everyone else - an ordinary person standing in line for happiness among other ordinary individuals.',
        quote_ru: 'Если учить, что учат все, писать код, как все, отдыхать, как все, будешь, как все — заурядной личностью стоящей в очереди за счастьем среди других заурядных личностей.',
        image: DataImages.experts.Zarubin,
        direction: [
            'Kotlin',
            'Flutter',
            'Aurora OS',
        ...
        media: {
            ...
            youtube: 'https://www.youtube.com/@user-si5qp1yc9k',
            site: 'https://keygenqt.com/',
        },
    },
    {
        id: 8,
        name_en: 'Anna Zharkova',
        name_ru: 'Анна Жаркова',
        description_en: `
Mobile Broadcast Expert for Android, iOS and Kotlin Multiplatform.

Head of the Android/iOS development team at Usetech.

Mobile developer with over 9 years of experience in commercial development. KMP Developer Expert. Engaged in native iOS (Swift/Objective-C), Android (Kotlin/Java) and cross-platform (KMM, Xamarin) development.
...
Member of PC Mobius, Codefest, Podlodka Android, Android Worldwide. Speaker at Mobius, Droidcon, Android Worldwide, AppsConf conferences.
        `.trim(),
        description_ru: `
Mobile Broadcast Expert по Android, iOS и Kotlin Multiplatform.

Руководитель группы разработки Android/iOS в Usetech.

Мобильный разработчик с более 9 годами опыта в коммерческой разработке. KMP Developer Expert. Занимается нативной разработкой iOS (Swift/Objective-С), Android (Kotlin/Java) и кроссплатформенной (KMM, Xamarin).
...
Член ПК Mobius, Codefest, Podlodka Android, Android Worldwide. Спикер на конференциях Mobius, Droidcon, Android Worldwide, AppsConf.
        ...
        quote_en: '',
        quote_ru: '',
        image: DataImages.experts.Zharkova,
        direction: [
            'Android',
            'iOS',
            'Kotlin',
        ...
        contacts: {
            telegram: undefined,
            email: undefined,
            linkedin: 'https://www.linkedin.com/in/anna-zharkova-56799780/',
        },
        media: {
            telegram: 'https://t.me/prettygeeknotes',
            github: 'https://github.com/anioutkazharkova',
            youtube: undefined,
            site: undefined,
        },
    },
    {
        id: 9,
        name_en: 'Andrey Zonov',
        name_ru: 'Андрей Зонов',
        description_en: `
Mobile Broadcast Expert for iOS.
...
Develops a local mobile community in Voronezh, speaks at conferences, Mobius, CrossConf, etc.
        `.trim(),
        description_ru: `
Mobile Broadcast Expert по iOS.
...
Развивает локальное мобильное сообщество в Воронеже, выступает на конференциях, Mobius, CrossConf и др.
        ...
        quote_en: '',
        quote_ru: '',
        image: DataImages.experts.Zonov,
        direction: [
            'iOS'
        ],
        contacts: {
            telegram: undefined,
            email: undefined,
            linkedin: 'https://www.linkedin.com/in/avzonov/',
        },
        media: {
            telegram: 'https://t.me/ios_broadcast',
            github: undefined,
            youtube: undefined,
            site: undefined,
        },
