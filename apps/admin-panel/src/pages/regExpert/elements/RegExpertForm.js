    ...
    return (
        <Formik
            ...
            onSubmit={async (values, {setErrors, setStatus, setFieldValue}) => {
                ...
                try {
                    const response = await Shared.httpClient.put.editRegExpert(props.id, new Shared.requests.RegExpertEditRequest(
                        values.note,
                        Shared.RegExpertState.valueOf(values.state),
                    ))
                        ...
                        <Box id={'FormId'}>
                            <Stack spacing={2} >
                                ...
                                <TextField
                                        ...
                                        select
                                    >
                                        {Shared.RegExpertStates?.map((item) => (
