...
export function RegOrganizerForm(props) {
    ...
    return (
        <Formik
            ...
            onSubmit={async (values, {setErrors, setStatus, setFieldValue}) => {
                ...
                try {
                    const response = await Shared.httpClient.put.editRegOrganizer(props.id, new Shared.requests.RegOrganizerEditRequest(
                        values.note,
                        ...
                        <Box id={'FormId'}>
                            <Stack spacing={2} >
                                ...
                                <TextField
                                        ...
                                        select
                                    >
                                        {Shared.RegOrganizerStates?.map((item) => (
