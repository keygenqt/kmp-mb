    ...
    translation: {
        ...
        pages: {
            ...
            registrationOrganizer: {
                t_title: 'Application for the Mobile Broadcast group organizer',
                t_text: 'If you want to start organizing a new Mobile Broadcast group, you can apply through this form. Check out the existing ',
                t_text_link: 'existing groups',
                t_subtext: 'You can become representatives of Android Broadcast and Mobile Developer, Kirill Rozov and Alexey Gladkov, so it is important for us to know who you are and your motivation, as well as other information.',
                t_error_form: 'The form is filled out incorrectly, please check.',
                t_success_reg: 'The application has been sent. Thank you!',
                t_block1_title: 'Contact details',
                t_block1_subtitle: 'Please fill in your contact details for communication.',
                t_block2_title: 'Group Information',
                t_block2_subtitle: 'Please specify where you would like to become a group organizer.',
                t_checkbox_info: 'You can read about the responsibilities of a group organizer at the link: ',
                t_checkbox_info_link: 'group organizer responsibilities',
                t_block3_title: 'About yourself',
                t_block3_subtitle: "Let's get acquainted, fill in a little information about your goals and experience.",
                t_field_fname: 'First name',
                t_field_lname: 'Last name',
                t_field_activity: 'Media activity',
                t_field_activity_help: "Indicate links to your social networks. If you don't, describe why you don't.",
                t_field_experience: 'Experience',
                t_field_experience_help: 'Tell us about your experience of organizing something.',
                t_field_why: 'Motivation',
                t_field_why_help: 'Describe in detail your motivation for organizing a group.',
                t_field_telegram: 'Telegram',
                t_field_email: 'E-Mail',
                t_field_emailNotion: 'E-Mail Notion',
                t_field_emailNotion_help: 'E-Mail of your Notion account. If not, you need to create one.',
                t_field_city: 'City',
                t_field_country: 'Country',
                t_field_expectations: 'Expectations',
                t_field_expectations_help: 'What are your expectations for help from the Mobile Broadcast organizers?',
                t_field_checkbox: "I agree with the organizer's responsibilities.",
                t_button_submit: 'Submit',
            },
            registrationPartner: {
                t_title: 'Application for partners of the Mobile Broadcast group',
                t_text1: 'Mobile Broadcast is an international community for everyone who is passionate about mobile development. This is a place where the boundaries between platforms are erased, and the only thing that matters is interest and passion for mobile technologies.',
                t_text2: "We don't care about the level of participants, we are glad to see everyone - both beginners and experienced developers with extensive experience.",
                t_text3: 'Our community is a network in 25+ cities of Belarus, Russia, Kazakhstan, Tajikistan, Uzbekistan, Georgia, Turkey, UAE, Thailand. We want to develop not only the mobile direction, but also the tech sphere as a whole.',
                t_text4: "That's why we need support and partnership, because with your help we will be able to expand the horizons of the community, and it will be easier for us to promote technologies to the world.",
                t_error_form: 'The form is filled out incorrectly, please check it.',
                t_success_reg: 'Request sent. Thank you!',
                t_form_title: 'Contact details',
                t_form_subtitle: 'Fill in some information about yourself and we will contact you.',
                t_form_format_title: 'In what format do you see our partnership?',
                t_field_company: 'Company',
                t_field_fname: 'First name',
                t_field_lname: 'Last name',
                t_field_email: 'E-Mail',
                t_field_telegram: 'Telegram',
